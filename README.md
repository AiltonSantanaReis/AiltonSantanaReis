...
Software Engineering student and backend-focused developer building real-world applications with TypeScript, Node.js, PostgreSQL, Docker, automated testing, and desktop/web product architecture.

I am currently focused on building production-oriented systems with clean architecture, authentication, RBAC, local-first data storage, CI pipelines, and reliable validation flows.
